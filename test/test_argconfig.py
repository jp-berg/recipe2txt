...
class TestBasicOption(TestInit):
    ...
    def test_from_toml(self):
        tomldict = {
            init_param["option_name"][2:]: f"NEW DEFAULT VALUE {idx}"
...
co_params = [(co_params_1, co_valid_string_1), (co_params_2, co_valid_string_2)]
...
t_params = [(t_params_1, t_valid_string_1), (t_params_2, t_valid_string_2)]
...
b_params_2 = {
    "option_name": "debug",
    "help_str": "Toggles debug-mode",
    "default": False,
}

b_params = [(b_params_1, b_valid_string_1), (b_params_2, b_valid_string_2)]
...
all_options = [
    (argconfig.BasicOption(**params), valid_string) for params, valid_string in params
]
all_options += [
    (argconfig.ChoiceOption(**params), valid_string)
    for params, valid_string in co_params
]
all_options += [
    (argconfig.TypeOption(**params), valid_string) for params, valid_string in t_params
]
all_options += [
    (argconfig.BoolOption(**params), valid_string) for params, valid_string in b_params
]
all_options += [
    (argconfig.NArgOption(**params), valid_string) for params, valid_string in n_params
]
